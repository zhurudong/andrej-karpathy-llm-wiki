...
![Codex drives the app with Chrome DevTools MCP to validate its work](assets/2026-02-11-harness-engineering-en/01-codex-chrome-devtools-mcp.png)
...
![Giving Codex a full observability stack in local dev](assets/2026-02-11-harness-engineering-en/02-codex-observability-stack.svg)
...
![The limits of agent knowledge: What Codex can't see doesn't exist](assets/2026-02-11-harness-engineering-en/03-agent-knowledge-limits.png)
...
![Layered domain architecture with explicit cross-cutting boundaries](assets/2026-02-11-harness-engineering-en/04-layered-domain-architecture.png)
