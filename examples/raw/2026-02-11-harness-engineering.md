...
ingested: 2026-04-24
lang: zh-Hans
acknowledgments: [Victor Zhu, Zach Brock]
---
...
![Codex 使用 Chrome DevTools MCP 驱动应用程序以验证其工作](assets/2026-02-11-harness-engineering/01-codex-chrome-devtools-mcp.png)
...
![在本地开发中赋予 Codex 完整的可观察性堆栈](assets/2026-02-11-harness-engineering/02-codex-observability-stack.svg)
...
![智能体知识的局限性：Codex 看不到的东西就不存在](assets/2026-02-11-harness-engineering/03-agent-knowledge-limits.png)
...
![具有明确交叉界限的分层领域架构](assets/2026-02-11-harness-engineering/04-layered-domain-architecture.png)
...
在以人为本的工作流程中，这些规则可能会让人感到迂腐或束缚。有了智能体，它们就成了**倍增器**：一旦编码，它们就能立即应用于所有地方。
...
显而易见的是：构建软件仍然需要纪律，但纪律更多地体现在**支撑结构**上，而不是代码上。保持代码库一致性的工具、抽象和反馈回路变得越发重要。
...
**致谢**：特别感谢 Victor Zhu 和 Zach Brock 为这篇文章做出的贡献，以及开发这款新产品的整个团队。
